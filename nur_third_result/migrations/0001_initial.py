...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='nur_third_result',
            constraint=models.UniqueConstraint(fields=('session_name', 'section_name', 'class_name', 'first_name', 'middle_name', 'last_name', 'date_of_birth', 'gender', 'passport', 'full_name'), name='unique_nur_third_result'),
        ),
    ]
